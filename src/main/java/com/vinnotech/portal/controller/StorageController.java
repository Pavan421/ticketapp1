...
public class StorageController {
	...
	public ResponseEntity<String> uploadFile(@PathVariable String empId, @RequestParam(name = "name") String name,
			@RequestParam(name = "value") String value, @RequestParam(value = "file") MultipartFile file) {
		return new ResponseEntity<>(service.uploadFile(empId, name, value, file), HttpStatus.OK);
	}
